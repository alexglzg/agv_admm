...
ocpX.set_der(psi, v*tan(delta)/L)
...
_, d_samp = ocpX.sample(delta, grid='control-')
...
outputs = [x_samp, y_samp, v_samp, d_samp]
output_names = ['x_samp', 'y_samp', 'v_samp', 'd_samp']

## Create CasADi function
ocpX_function = ocpX.to_function('b_ocpX', 
                                inputs,
                                outputs, 
                                input_names,
                                output_names)
...
## Serialize function
ocpX_function.save('b_ocpX.casadi')
